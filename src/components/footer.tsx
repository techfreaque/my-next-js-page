          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="text-center md:text-left">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-2 border-blue-500 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950 hover:border-blue-600 backdrop-blur-sm rounded-xl font-semibold"
              >
                <a
