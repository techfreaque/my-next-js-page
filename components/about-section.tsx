            ...
            <div className="space-y-8">
              ...
              >
                <RainbowButton
                  ...
                  className="text-center px-8 py-4 border-2 border-blue-500/50 bg-blue-500/10 hover:bg-blue-500/20 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  Let's Collaborate! 🚀
                </RainbowButton>
              </div>
            ...
            <div className="space-y-10">
              ...
              <div>
                <h3
                  ...
                  style={getFancySubtitleStyle(isHover, "primary")}
                >
                  Magical Arsenal
                </h3>
